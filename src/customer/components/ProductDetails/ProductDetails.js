...
const ratings = [
  ...
  { label: "Good", value: 50, count: 60 },
  { label: "Average", value: 30, count: 40 },
  { label: "Poor", value: 10, count: 20 },
];
const product = {
      ...
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">112 Ratings</p>
                  <p className="ml-3 font-medium text-indigo-600 text-sm hover:text-indigo-500">
                    3870 Reviews
                  </p>
                </div>
              </div>
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">233 Ratings</p>
                </div>
        ...
        <Box sx={{ padding: 4 }}>
          ...
          <Grid container spacing={4}>
            ...
            {/* Right Column: Ratings Progress Bars */}
            <Grid item xs={12} md={6}>
              <Box>
                {ratings.map((rating) => (
                  <Box key={rating.label} sx={{ marginBottom: 2 }}>
